...
namespace uMatrixCleaner
{
    ...
    public class HostPredicate
    {
        ...
        internal static readonly DomainParser domainParser = new DomainParser(new FileTldRuleProvider(System.IO.Path.Combine(System.AppContext.BaseDirectory, "public_suffix_list.dat")));
